...
let SetItemButton = document.getElementById('setItem');
let GetItemButton = document.getElementById('getItem');
let ClearItemButton = document.getElementById('clearItem');
let c1 = document.getElementById('container_1');
let c2 = document.getElementById('container_2');

c1.appendChild(c2);
setStorageByLocalStorage = () => {
    localStorage.setItem('item_1' , 'Value 1');
    localStorage.setItem('item_2' , 'Value 2');
    localStorage.setItem('item_3' , 'Value 3');
}

function getStorageByLocalStorage() {
    Object.keys(localStorage).forEach((item , key) => {
       let value =  localStorage[item];
       let paraEle = document.createElement('p');
       paraEle.textContent = `${key} : ${value}`;
       c2.appendChild(paraEle);
    })

}
GetItemButton.addEventListener('click' ,getStorageByLocalStorage)

SetItemButton.addEventListener('click' , setStorageByLocalStorage)